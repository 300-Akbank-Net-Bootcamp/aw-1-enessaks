...
{
    /// Represents the Employee entity with validation attributes and custom validation logic.
    public class Employee : IValidatableObject
    {
        ...
        /// Custom validation logic for the Employee entity.
    ...
    /// Custom validation attribute to ensure the minimum legal salary requirement.
    ...
    /// Validator class for the Employee entity using FluentValidation library.
